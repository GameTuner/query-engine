...
class ColumnValuesQueryDTO:
    page_id: str
    request_id: str
    date_interval: DateInterval
    column_id: str

    def to_domain_model(self, app_id: str, app_repository: AppRepository,
                        datasource_repository: DataSourceRepository) -> ColumnValuesQuery:
        app = app_repository.from_app_id(app_id)
        column_ref = datasource_repository.load_column_by_full_id(app, self.column_id)
